...
<head>
    <meta charset="UTF-8">
    <title>View Mercedes Information</title>
        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr><td style='width:600px;border:1px solid black;'>".$row["id"]."</td><td style='width:600px;border:1px solid black;'>"
                    .'<img src="image/"'.$row["image"].">'</td><td style='width:200px;border:1px solid black;'>"." ".$row["image_name"]."</td>
                        <td style='width:600px;border:1px solid black;'><a href=delete.php?id=".$row["id"].">Delete</a>
                            </td><td style='width:600px;border:1px solid black;'><a href=edit.php?id=".$row["id"].">Edit</a></td></tr>";
